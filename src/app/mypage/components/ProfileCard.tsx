...
export const ProfileCard = () => {
    ...
    return (
        <div className="flex flex-col max-w-screen-xl mx-auto gap-2.5">
            {/* 헤더 */}
            ...
            <div className="flex flex-col p-4 gap-5 bg-[#F7F7FA] rounded-[20px] border border-[#E1E1E4]">
                ...
                {/* 비밀번호 수정 */}
                <div className="flex flex-col md:h-293.5 px-6 py-4 md:px-15 md:py-10 gap-3 bg-white rounded-[20px] justify-center">
                    <div className="flex flex-row justify-between items-center">
